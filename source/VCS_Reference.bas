...
Public Function VCS_ImportReferences(ByVal obj_path As String) As Integer
    Dim FSO As Object
    ...
    If Len(FileName) = 0 Then
        Debug.Print "No references file found at " & obj_path & "references.csv"
        VCS_ImportReferences = 0
        Exit Function
    End If
...
failed_guid:
    ...
    Else
        Debug.Print ""
        Debug.Print "Failed to register " & GUID, , "Error: " & Err.Number
...
Public Function VCS_ExportReferences(ByVal obj_path As String) As Integer
    Dim FSO As Object
